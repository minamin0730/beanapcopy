//
//  ViewController.m
//  TwitterFrameworkSample
//
//  Created by 岡田みなみ on 2014/08/19.
                                ...
                                completion:^(BOOL granted, NSError *error) {
                                    ...
                                    if (!granted) {
                                        ...
                                        if ([twitterAccounts count] > 0) {
                                            ...
                                            [params setObject:@"%23Beanap" forKey:@"q"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UILabel *urlLabel = (UILabel*)[cell viewWithTag:3];
    ...
    //画像情報
    NSDictionary *entitiesInfo = tweetMessage[@"entities"];
    NSArray *mediaInfos = [entitiesInfo objectForKey:@"media"];
    NSDictionary *mediaInfo = mediaInfos[0];
    //セルにTweetの内容とユーザー名を表示
    //tweetLabel.text = [tweetMessage objectForKey:@"text"];
    //userLabel.text = [userInfo objectForKey:@"screen_name"];
    //urlLabel.text = [mediaInfo objectForKey:@"media_url"];
    //dateLabel.text = [tweetMessage objectForKey:@"created_at"];
    tweetLabel.text = [mediaInfo objectForKey:@"media_url"];
    userLabel.text = [tweetMessage objectForKey:@"created_at"];
    
    NSString *url = [mediaInfo objectForKey:@"media_url"];
    NSLog(@"%@" ,url);
